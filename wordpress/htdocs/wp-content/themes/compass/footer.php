...
<div class="bottom_footer_content">
    <div class="grid_16 alpha">         
        <div class="copyrightinfo">
            <p class="copyright"><a href="http://wordpress.org/" rel="generator"><?php _e('Powered by WordPress', 'compass');
    ?></a>
                <span class="sep">&nbsp;|&nbsp;</span>
                <?php
                printf(__('%1$s by %2$s.', 'compass'), 'Compass', '<a href="http://inkthemes.com/" rel="designer">InkThemes</a>');
                ?></p>
        </div>
    </div>
